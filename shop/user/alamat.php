        ...
        <div class="card-body bg-white">
            ...
            <form class="form" action="<?= base_url('shop/user/aksi.php') ?>" method="POST" entype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="form-group">
                            <input type="text" class="form-control" name="kota" placeholder="Isi Kota Alamat anda dengan benar" required="required">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                        <div class="form-group">
                            <input type="text" class="form-control" name="kecamatan" placeholder="Isi Kecamatan dengan Benar" required="required">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        Kode Pos
                    ...
                    <div class="col-lg-9">
                        <div class="form-group">
                            <input type="text" class="form-control" name="kode_pos" placeholder="Isi Kode Pos dengan Benar" required="required">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        Alamat Lengkap
                    ...
                    <div class="col-lg-9">
                        <div class="form-group">
                            <textarea name="alamat_lengkap" id="" class="form-control" required></textarea>
                        </div>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <button type="submit" name="btnSIMPANALAMAT"><span class="badge badge-primary">Simpan</span></button>
                    </div>
