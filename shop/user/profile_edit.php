                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="form-group">
                            <input type="text" class="form-control" name="nama_lengkap" value="<?= $profile['nama_lengkap'] ?>" placeholder="Nama Lengkap" required="required">
                    ...
                    <div class="col-lg-9">
                        <div class="form-group">
                            <input type="email" class="form-control" name="email" value="<?= $profile['email'] ?>" placeholder="Isi Email dengan Benar" required="required">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                        <div class="form-group">
                            <input type="text" class="form-control" name="nomer_hp" value="<?= $profile['nomer_hp'] ?>" placeholder="Isi Email dengan Benar" required="required">
                        </div>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <button type="submit" name="btnUPDATEUSER"><span class="badge badge-primary">Simpan</span></button>
                    </div>
