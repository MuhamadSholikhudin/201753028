...
<div class="col-lg-9 col-md-8 col-12">
    ...
    <div class="row">
        ...
        <?php 
            ...
            $sql_produks = "SELECT * FROM produk JOIN kategori ON produk.id_kategori = kategori.id_kategori WHERE kategori.kategori ='".$_GET['kategori']."'";
                    ...
                    <div class="product-img">
                        ...
                        <div class="button-head">
                            <div class="product-action">
                                <a title="Quick View" href="<?= base_url('shop/index.php?halaman=detail_produk&id_produk=') . $data_produks['id_produk'] ?>"><i class=" ti-eye"></i><span>Quick Shop</span></a>
