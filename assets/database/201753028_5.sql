...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2022 at 01:10 AM
...
(5, '2022-07-26', '2022-07-27', 2, 70000, '19,20', 31);
...
(5, 5, 'RV1658835446', 70000, '16588355512x6m.jpg', 4, '2022-07-26', 1, 31);
...
INSERT INTO `pengiriman` (`id_pengiriman`, `id_user`, `nama_penerima`, `nomor_penerima`, `id_pembayaran`, `provinsi`, `kota`, `kecamatan`, `kode_pos`, `alamat_lengkap`, `alamat_jalan`, `status_pengiriman`, `tanggal_pengiriman`, `keterangan`, `bukti_pengiriman`) VALUES
(2, 31, 'yusuf', '123', 5, 'jawa tengah', 'Kudus', 'Kudus Kota', '123', 'Rumah bapak Johan, RT.2/RW 56 Mlati Mejobo Kudus Jawa Tengah', '', 3, '2022-07-28', '123', '1659005807adit2.png');
...
ALTER TABLE `keranjang_gerai`
  ...
  ADD KEY `id_stok_gerai` (`id_stok_gerai`),
  ADD KEY `id_penjualan_gerai` (`id_penjualan_gerai`);
...
ALTER TABLE `checkout`
  ...
  ADD CONSTRAINT `checkout_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`);
...
ALTER TABLE `keranjang`
  ...
  ADD CONSTRAINT `keranjang_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`);

--
-- Constraints for table `keranjang_gerai`
--
ALTER TABLE `keranjang_gerai`
  ADD CONSTRAINT `keranjang_gerai_ibfk_1` FOREIGN KEY (`id_stok_gerai`) REFERENCES `stok_gerai` (`id_stok_gerai`),
  ADD CONSTRAINT `keranjang_gerai_ibfk_2` FOREIGN KEY (`id_penjualan_gerai`) REFERENCES `penjualan_gerai` (`id_penjualan_gerai`);

--
-- Constraints for table `pembayaran`
--
ALTER TABLE `pembayaran`
  ADD CONSTRAINT `pembayaran_ibfk_1` FOREIGN KEY (`id_checkout`) REFERENCES `checkout` (`id_checkout`),
...
--
-- Constraints for table `pesanan_stok_gerai`
--
ALTER TABLE `pesanan_stok_gerai`
  ADD CONSTRAINT `pesanan_stok_gerai_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`);
...
--
-- Constraints for table `stok_gerai`
--
ALTER TABLE `stok_gerai`
  ADD CONSTRAINT `stok_gerai_ibfk_1` FOREIGN KEY (`id_gerai`) REFERENCES `gerai` (`id_gerai`);
COMMIT;
