...
<div class="col">
    <div class="card card-small mb-4">
      <div class="card-header border-bottom">
        ...
        <a href="<?= base_url('pemilik/bank/tambah/') ?>" type="button" class="btn btn-primary"> + Tambah</a>
        </h6>
      </div>
        ...
        <thead class="bg-light">
          ...
          <?php foreach($bank as $ban): ?>
            <tr>
              ...
              <td><?= $ban->atas_nama ?></td>
              <td>
              <img src="<?= base_url('uploads/bank/'. $ban->gambar_logo ) ?>" alt="<?= $ban->gambar_logo ?>" width="50px">
              
              </td>
              <td>        <a href="<?= base_url('pemilik/bank/edit/'. $ban->id_bank) ?>" type="button" class="btn btn-success"> Edit</a>
