...
if (isset($_GET['id_pengiriman'])) {
    $pengiriman = querysatudata(
        'SELECT * FROM pengiriman WHERE id_pengiriman = ' . $_GET['id_pengiriman'] . ''
    );
}
?>
                                ...
                                <form action="<?= base_url('vapor/pengiriman/aksi.php') ?>" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group ">
                                            ...
                                            <img id="output" />
                                            <input type="file" class="form-control" id="gambar" name="bukti_pengiriman" accept="image/png, image/jpeg, image/jpg, image/img" onchange="loadFile(event)">
                                        </div>
                                        <script>
