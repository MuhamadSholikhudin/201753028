...
if (isset($_GET['id_pembayaran'])) {
    $pembayaran = querysatudata(
        'SELECT * FROM pembayaran JOIN bank ON pembayaran.id_bank = bank.id_bank WHERE id_pembayaran = ' .
            $_GET['id_pembayaran'] .
            ''
    );
}
...
<div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 col-12">
                <div class="order-details mb-3">
                    ...
                    <form action="<?= base_url(
                        ...
                        <div class="single-widget get-button">
                            <div class="content">
                                <div class="button">
                                    <input type="hidden" name="id_pembayaran" value="<?= $pembayaran[
                                        'id_pembayaran'
                                    ] ?>" id="">
                ...
                <?php if ($pembayaran['status_pembayaran'] == 3) { ?>
