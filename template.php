...
<head>
	...
	<!-- Bootstrap -->
	<link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/bootstrap.css">
	<!-- Magnific Popup -->
    <link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/magnific-popup.min.css">
	<!-- Font Awesome -->
    <link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/font-awesome.css">
	<!-- Fancybox -->
	<link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/jquery.fancybox.min.css">
	<!-- Themify Icons -->
    <link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/themify-icons.css">
	<!-- Nice Select CSS -->
    <link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/niceselect.css">
	<!-- Animate CSS -->
    <link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/animate.css">
	<!-- Flex Slider CSS -->
    <link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/flex-slider.min.css">
	<!-- Owl Carousel -->
    <link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/owl-carousel.css">
	<!-- Slicknav -->
    <link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/slicknav.min.css">
	
	<!-- Eshop StyleSheet -->
	<link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/reset.css">
	<link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>style.css">
    <link rel="stylesheet" href="<?= $url_assets."/eshop/" ?>css/responsive.css">
...
<body class="js">
					...
					<div class="col-lg-8 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								...
								<?php if ($_SESSION['username_masyarakat'] ) { ?>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="index.html"><img src="<?= $url_assets."/eshop/" ?>/images/content-management/raja_vapor.jpg" width="40px" style="" alt="logo"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
								...
								<div class="shopping-item">
									...
									<div class="bottom">
										<div class="total">
											...
											// Jika Sudah Login
											if($this->session->userdata('id_user')){
												$total_keranjang = $this->db->query("SELECT SUM(harga_keranjang) as total FROM keranjang WHERE id_user = $id_user and status_keranjang = 1 ")->row();
												echo $total_keranjang->total;
											}else{
												echo 0;
											}?>
											</span>
						...
						<div class="shop-sidebar">
								...
								<div class="single-widget category">
									...
									<ul class="categor-list">
										<?php foreach($kategories as $kategori) : ?>
											<li><a href="http://localhost/index/kategori/') . $kategori->kategori ?>"><?= $kategori->kategori ?></a></li>
								...
								<!-- Shop By Price -->
									<div class="single-widget range">
										...
										<ul class="check-box-list">
											<?php
												$range_awal = $this->db->query("SELECT * FROM barang ORDER BY harga_barang ASC")->row();
												echo $range_awal->harga_barang;

												echo '<br>';
												$range_akhir = $this->db->query("SELECT * FROM barang ORDER BY harga_barang DESC")->row();
												echo $range_akhir->harga_barang;
												echo '<br>';

												echo $selang = $range_akhir->harga_barang - $range_awal->harga_barang;
								...
								<div class="single-widget recent-post">
									...
									<?php 
										...
										// $barang_baru = $this->db->query("SELECT * FROM barang ORDER BY id_barang DESC LIMIT 3")->result();
									?>
	...
	<!-- Jquery -->
    <script src="<?= $url_assets."/eshop/" ?>js/jquery.min.js"></script>
    <script src="<?= $url_assets."/eshop/" ?>js/jquery-migrate-3.0.0.js"></script>
	<script src="<?= $url_assets."/eshop/" ?>js/jquery-ui.min.js"></script>
	<!-- Popper JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/popper.min.js"></script>
	<!-- Bootstrap JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/bootstrap.min.js"></script>
	<!-- Color JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/colors.js"></script>
	<!-- Slicknav JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/slicknav.min.js"></script>
	<!-- Owl Carousel JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/owl-carousel.js"></script>
	<!-- Magnific Popup JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/magnific-popup.js"></script>
	<!-- Waypoints JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/waypoints.min.js"></script>
	<!-- Countdown JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/finalcountdown.min.js"></script>
	<!-- Nice Select JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/nicesellect.js"></script>
	<!-- Flex Slider JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/flex-slider.js"></script>
	<!-- ScrollUp JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/scrollup.js"></script>
	<!-- Onepage Nav JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/onepage-nav.min.js"></script>
	<!-- Easing JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/easing.js"></script>
	<!-- Active JS -->
	<script src="<?= $url_assets."/eshop/" ?>js/active.js"></script>
</body>
</html>